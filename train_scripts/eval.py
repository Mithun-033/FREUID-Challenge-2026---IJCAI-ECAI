...
# state_dict=torch.load("best_model_1.pt", map_location=device)
...
# print(f"Saved {len(results)} predictions to predictions_1.csv")
...
sample.reset_index().to_csv("submission_3.csv", index=False)